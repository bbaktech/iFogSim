//ModulePlacementPriorityWise.java
...
public class ModulePlacementPriorityWise extends ModulePlacement{
	...
	public ModulePlacementPriorityWise(List<FogDevice> fogDevices, List<Sensor> sensors, List<Actuator> actuators, 
